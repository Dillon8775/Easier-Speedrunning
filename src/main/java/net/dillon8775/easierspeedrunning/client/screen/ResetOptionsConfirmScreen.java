...
public class ResetOptionsConfirmScreen extends GameOptionsScreen {
    ...
    protected void init() {
        ...
        this.addButton(new ButtonWidget(leftSide, height, 150, 20, ModTexts.RESET, (buttonWidget) -> {
            ...
            this.client.openScreen(new ResetOptionsScreen(this.parent, MinecraftClient.getInstance().options));
        }));
        this.addButton(new ButtonWidget(rightSide, height, 150, 20, ModTexts.NOT_NOW, (buttonWidget) -> {
            this.onClose();
        }));
    }
