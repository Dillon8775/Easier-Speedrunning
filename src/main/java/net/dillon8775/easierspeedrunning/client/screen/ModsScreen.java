...
public class ModsScreen extends GameOptionsScreen {
    ...
    protected void init() {
        ...
        ButtonWidget kryptonButton = this.addDrawableChild(new ButtonWidget(rightSide, height, 150, 20, ModTexts.KRYPTON, (buttonWidget) -> {
            Util.getOperatingSystem().open(ModLinks.KRYPTON);
