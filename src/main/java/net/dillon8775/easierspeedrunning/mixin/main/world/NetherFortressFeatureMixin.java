...
public class NetherFortressFeatureMixin {
    @Shadow
    private static final List<SpawnSettings.SpawnEntry> MONSTER_SPAWNS = DOOM_MODE ? ImmutableList.of(
            ...
            ImmutableList.of(new SpawnSettings.SpawnEntry(EntityType.BLAZE, 15, 1, 4),
