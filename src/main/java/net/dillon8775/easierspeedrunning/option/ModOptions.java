...
public class ModOptions {
    ...
    public enum StructureSpawnRates {
        ...
        public boolean everywhere() {
            return options().structureSpawnRates.equals(StructureSpawnRates.EVERYWHERE);
        }

        public boolean veryCommon() {
            return options().structureSpawnRates.equals(StructureSpawnRates.VERY_COMMON);
        }

        public boolean common() {
            return options().structureSpawnRates.equals(StructureSpawnRates.COMMON);
        }

        public boolean normal() {
            return options().structureSpawnRates.equals(StructureSpawnRates.NORMAL);
        }

        public boolean ddefault() {
            return options().structureSpawnRates.equals(StructureSpawnRates.DEFAULT);
        }

        public boolean commonNormalOrDefault() {
            return options().structureSpawnRates.equals(StructureSpawnRates.COMMON) || options().structureSpawnRates.equals(StructureSpawnRates.NORMAL) || options().structureSpawnRates.equals(StructureSpawnRates.DEFAULT);
        }

        public boolean rare() {
            return options().structureSpawnRates.equals(StructureSpawnRates.RARE);
        }

        public boolean veryRare() {
            return options().structureSpawnRates.equals(StructureSpawnRates.VERY_RARE);
        }
    }
