...
public class EasierSpeedrunningClient implements ClientModInitializer {
    ...
    /**
     * Sends error message, used in {@link net.dillon8775.easierspeedrunning.mixin.client.Keybindings}.
     */
    public static void logException(Exception ex, String message) {
        System.err.printf("[Easier Speedrunning] %s (%s: %s)", message, ex.getClass().getSimpleName(), ex.getLocalizedMessage());
    }
}